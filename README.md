...
| Корзина: удаление, восстановление, очистка | Папки и теги в интерфейсе |
| Полнотекстовый поиск (FTS5) + история запросов | Вложения и голосовые заметки |
| Напоминания со звуком и шаблонами времени | |
...
| Резервная копия и восстановление из файла | Шифрование базы |
| Темы оформления и 8 языков интерфейса | |
