...
export const ru = {
  ...
  "checklist.clear": "Убрать чек-лист",
  "checklist.clearConfirm": "Удалить все пункты ({count})?",
  "checklist.clearYes": "Удалить",
  ...
  "filing.all": "Все",
  "filing.manage": "Изменить теги",
  "filing.manageDone": "Готово",
  "filing.removeTag": "Удалить тег «{name}»",
  "filing.clear": "Снять все теги ({count})",

  "appName.title": "Название приложения",
  "appName.hint": "До {max} символов. Пустое поле вернёт xima.keeps.",

  "quick.dictate": "Продиктовать заметку",
  "quick.title": "Быстрая заметка",
  "quick.hint": "Скажите, что нужно запомнить и когда. Например: «встреча, 15:00».",
  "quick.starting": "Готовлю микрофон…",
  "quick.listening": "Слушаю",
  "quick.thinking": "Разбираю сказанное…",
  "quick.saving": "Создаю заметку…",
  "quick.done": "Готово",
  "quick.again": "Ещё раз",
  "quick.allow": "Разрешить",
  "quick.cancel": "Отмена",
  "quick.close": "Закрыть диктовку",
  "quick.denied": "Без доступа к микрофону диктовать не получится. Его можно включить в настройках Android.",
  "quick.unavailable": "На этом устройстве нет распознавания речи.",
  "quick.created": "«{title}» — напомню в {when}",
  "quick.createdLater": "«{title}» — напомню {when}",
  "quick.createdWithLead": "«{title}» — сказали {spoken}, напомню в {when}",
  "quick.undo": "Отменить",
  "quick.openSettings": "Открыть настройки",
  "quick.deniedForGood": "Доступ к микрофону запрещён насовсем. Включить его можно только в настройках Android.",
  "quick.listeningIn": "Слушаю на языке: {language}",
  "quick.offlineNotGuaranteed": "На этом Android распознавание может уйти в интернет — офлайн здесь только пожелание.",
  "quick.downloadModel": "Скачать распознавание для этого языка",
  "quick.createdWithoutReminder": "«{title}» — заметка создана, без напоминания",
  "quick.open": "Открыть",
  "quick.dismiss": "Скрыть сообщение",

  "speech.noSpeech": "Ничего не расслышал. Попробуйте ещё раз.",
  "speech.permission": "Нет доступа к микрофону.",
  "speech.busy": "Распознавание сейчас занято. Попробуйте ещё раз.",
  "speech.audio": "Не получилось записать звук.",
  "speech.language": "Для этого языка не установлено распознавание без интернета. Его можно скачать в настройках Android.",
  "speech.offline": "Распознаванию понадобился интернет, а приложение работает только на устройстве.",
  "speech.unknown": "Распознать речь не удалось.",
  "speech.aborted": "Диктовка прервалась: приложение уходило в фон.",

  "quickSettings.title": "Быстрые заметки",
  "quickSettings.lead": "Напоминать заранее",
  "quickSettings.leadHint": "Сказали «встреча, 15:00» — напоминание придёт в 14:30.",
  "quickSettings.leadNone": "Вовремя",
  "quickSettings.minutes": "за {count} мин",
  "quickSettings.hours": "за {count} ч",
  "quickSettings.fallback": "Если время не названо",
  "quickSettings.fallbackHint": "«Купить молоко» — напоминание на это время.",
  "quickSettings.day": "На какой день",
  "quickSettings.dayToday": "Сегодня",
  "quickSettings.dayTomorrow": "Завтра",
  "quickSettings.dayOwn": "Свой",
  "quickSettings.dayCustom": "Через сколько дней",
  "quickSettings.dayHint": "«Сегодня» — если время уже прошло, напоминание встанет на завтра.",

  "snooze.title": "Отложить напоминание",
  "snooze.hint": "На столько сдвинется напоминание кнопкой «Отложить» в шторке.",
  "snooze.minutes": "{count} мин",
  "snooze.hours": "{count} ч",
  "reminders.title": "Напоминания",
  "reminders.empty": "Напоминаний пока нет.",
  "reminders.today": "Сегодня, {time}",
  "reminders.tomorrow": "Завтра, {time}",
