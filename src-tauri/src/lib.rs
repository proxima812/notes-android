...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            application::commands::folders_list,
            application::commands::folders_create,
            application::commands::folders_delete,
            application::commands::folders_of_note,
            application::commands::folders_set_for_note,
